...
export interface AetheriumShardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface AetheriumShard extends BaseContract {
  connect(runner?: ContractRunner | null): AetheriumShard;
  waitForDeployment(): Promise<this>;

  interface: AetheriumShardInterface;
